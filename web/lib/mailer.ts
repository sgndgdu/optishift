...
export function notificationEmailHtml(title: string, bodyText: string): string {
    ...
    <tr><td align="center">
      <table width="100%" style="max-width:480px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.08);">
        ...
        <tr><td style="padding:32px;">
          <h1 style="margin:0 0 8px;font-size:20px;font-weight:800;color:#0f172a;">${title}</h1>
          <p style="margin:0;color:#64748b;font-size:15px;line-height:1.6;">${bodyHtml}</p>
